			...
			function() {
				$("#search").click(
						function() {
							...
							window.location.href = "selectWork?classesname="
									+ classesname + "&name=" + name + "&time="
									+ time;
							alert("查询中,请稍后。。。。");
						});
...
<body>
	...
	<table border="0">
		<tr>
			<th scope="col"><a href="../StudentTest/jsp/teacherindex.jsp"><img
			...
			<th scope="col"><a
				href="../StudentTest/jsp/CommitPointAndUploadWork.jsp"><img
	...
	<form method="get" action="addWork">
		...
		<table width="75%" border="1" align="center" cellpadding="3"
			...
			style="border-collapse: collapse">
				<tr>
				<td align ="center"><b style="color: red" >条目名称</b></td>
				<td align ="center"><b style="color: red" >作业统计</b></td>
				</tr>
			<c:forEach items="${questionList}" var="question">
				<tr>
					<td><b style="color: red" >id：</b></td>
					<td><b style="color: red" >${question.id}</b></td>
				</tr>
				<tr>
					<td>作业科目：</td>
					<td><input name="coursename" value="${question.coursename}"
						type="hidden" />${question.coursename}</td>
				</tr>
				<tr>
					<td>班级名称：</td>
					<td><input name="classesname" value="${question.classesname}"
						type="hidden" />${question.classesname}</td>
				</tr>
				<tr>
					<td>作业内容：</td>
